...
# Add the 'lib' folder to Python's module search path
            ...
            for person in person_list:
                ...
                if len(parts) >= 2:
                    try:
                        ...
                        # Skip folders with non-integer second part
                        pass
            if person_num_list:
